...
export function BannerTable({
  ...
  const sampleBanners: Banner[] = banners.length > 0 ? banners : [
    {
      id: "1",
      title: "Summer Sale Banner",
      description: "Get up to 50% off on all summer collections. Limited time offer with amazing deals on fashion items.",
    ...
    },
    {
      ...
      description: "Introducing our latest product line with innovative features and modern design.",
      imageUrl: "https://images.unsplash.com/photo-1560472355-536de3962603?w=800&h=400&fit=crop",
      isActive: false,
    ...
    },
    {
      ...
      description: "Special holiday discounts available now. Don't miss out on these exclusive offers.",
  ...
  const displayBanners = sampleBanners;
