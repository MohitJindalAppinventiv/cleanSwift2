...
//   const [filters, setFilters] = useState<{ paymentMethod: string[] }>({
//     paymentMethod: [],
//   });
...
//     return data;
//   }, [payments, sortBy, sortOrder, filterStatus, filters]);
...
//     (key: "paymentMethod", value: string) => {
//       setFilters((prev) => {
//         const values = prev[key];
//         return {
//           ...prev,
//           [key]: values.includes(value)
//             ? values.filter((v) => v !== value) // remove
//             : [...values, value], // add
//         };
//       });
//     },
...
//             <CardContent className="pb-2">
//               <div className="text-2xl font-bold tracking-tight mb-1">
//                 {paymentStats.uniquePaymentMethods}
//               </div>
...
//         <DropdownMenuItem
//           key={method.value}
//           onClick={() => handleFilterChange("paymentMethod", method.value)}
...
//                         );
//                       }}
//                       className="text-right font-semibold text-foreground cursor-pointer select-none"
//                     >
//                       {" "}
...
//                                 No results match "{searchTerm}". Try adjusting
//                                 your search.
//                               </p>
//                             </div>
//                             <Button
...
//   // Generate page numbers for pagination - Updated to work with filtered data
//   const getPageNumbers = useMemo(() => {
//     const pages = [];
//     const filteredTotalItems = processedPayments.length;
//     const filteredTotalPages = Math.ceil(
//       filteredTotalItems / pagination.itemsPerPage
//     );
...
//     // Always show first page
//     if (filteredTotalPages > 0) pages.push(1);

//     // Calculate range around current page
//     const start = Math.max(2, currentPage - 2);
//     const end = Math.min(filteredTotalPages - 1, currentPage + 2);
...
//     return { pages, filteredTotalPages, currentPage };
//   }, [
...
//   // Get paginated processed payments
//   const paginatedPayments = useMemo(() => {
//     const startIndex = (pagination.currentPage - 1) * pagination.itemsPerPage;
//     const endIndex = startIndex + pagination.itemsPerPage;
//     return processedPayments.slice(startIndex, endIndex);
//   }, [processedPayments, pagination.currentPage, pagination.itemsPerPage]);
...
//             <CardTitle>Recent Payments</CardTitle>
//             <CardDescription>
//               A list of recent payment transactions ({processedPayments.length}{" "}
//               results)
//             </CardDescription>
//           </CardHeader>
//           <CardContent>
...
//                               </p>
//                               <p className="text-muted-foreground text-sm">
//                                 No results match your current filters. Try
...
//             {/* Enhanced Pagination */}
//             {getPageNumbers.filteredTotalPages > 1 && (
//               <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6 pt-4 border-t">
//                 <div className="text-sm text-muted-foreground order-2 sm:order-1">
//                   Showing{" "}
//                   {Math.min(
...
//                       handlePageChange(
//                         Math.min(
//                           getPageNumbers.filteredTotalPages,
              ...
              <Table>
                <TableHeader>
                  <TableRow className="hover:bg-transparent border-b bg-muted/50">
                    ...
                    {/* --- Sortable Amount with ArrowUpDown Icons --- */}
                    <TableHead
                      onClick={() => {
                        setSortBy("amount");
                        setSortOrder((prev) =>
                    ...
                    {/* --- Sortable Date with ArrowUpDown Icons --- */}
                    <TableHead
                      onClick={() => {
                        setSortBy("date");
                        setSortOrder((prev) =>
                  ...
                  {paginatedPayments.length === 0 ? (
                    ...
                    paginatedPayments.map((payment) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            <Link to={`../customer-details/${payment.userId}`}>
                            <span>{payment.customerName || "Unknown"}</span>
                            </Link>
                          </div>
                        </TableCell>
