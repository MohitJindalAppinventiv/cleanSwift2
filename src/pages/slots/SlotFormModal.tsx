...
//               value={propagateWeeks}
//               onChange={(e) => {
//                 const val = Math.max(1, Number(e.target.value)); // enforce min = 1
//                 setPropagateWeeks(val); // will never show leading 0
//               }}
//             />
//           </div>
...
//       // Check if both times are provided and end time is after start time
//       if (range.startTime && range.endTime) {
//         const startTime = new Date(`2000-01-01T${range.startTime}`);
//         const endTime = new Date(`2000-01-01T${range.endTime}`);
        
//         if (endTime <= startTime) {
//           newErrors.timeRanges[index].timeRange = "End time must be after start time";
//           hasErrors = true;
//         }
//       }
...
//     }
//     // Clear time range error when either time is updated
...
//                 {/* Time Range Error (for overlap or end < start) */}
