...
// //     const profileComplete=useAppSelector((state)=>state.profileStatus.data.configurations);
...
// //     try {
// //       const res = await axiosInstance.post(API.ADMIN_CREATE_AREA(), {
...
// //       toast({ title: "Store location saved successfully!" });
// //       setStoreName("");
// //       setServiceRadius("");
// //       if(profileComplete.service.isConfigured){
// //         navigate("/");
// //       } else navigate("/Serv")
// //     } catch (error) {
// //         console.log("Error",error);
// //       toast({ variant: "destructive", title: "Failed to save store location" });
// //     }
// //   };

// //   return (
// //     <div className="p-6 space-y-6 max-w-3xl mx-auto">
// //       <h2 className="text-xl font-semibold">Add Store Location</h2>
...
// //         <div className="p-2 border rounded bg-muted text-sm">{detectedAddress}</div>
// //       </div>
...
// //       <Button onClick={handleSubmit} disabled={!storeName || !serviceRadius}>
// //         Save Store Location
// //       </Button>
// //     </div>
// //   );
...
//     (state) => state.profileStatus.data.configurations
//   );
...
//   // Fetch detected address from coordinates
//   useEffect(() => {
//     if (!window.google || !window.google.maps) return;
...
//       try {
//         const response = await axiosInstance.get(API.ADMIN_GET_AREA());
//         console.log("Existing areas:", response.data);
//       } catch (error) {
...
//       <h1 className="text-2xl font-bold text-gray-800">Add New Store Location</h1>
...
// // Type for saved locations (you may already have this)
// interface Area {
//   _id: string;
//   locationName: string;
//   address: string;
...
//   // Get address for the selected marker
//   useEffect(() => {
//     if (!window.google || !window.google.maps) return;
//     const geocoder = new window.google.maps.Geocoder();
//     geocoder.geocode({ location: marker }, (results, status) => {
